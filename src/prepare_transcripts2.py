...
def prepare_transcripts(input_files,
    ...
    for fileName in file_list:
        ...
        # apply tags from custom dictionary
        if custom_dictionary == True:
                glossary = pd.read_csv(path_to_custom_dictionary)
                tt = dataframe['tagged_token']
                tl = dataframe['tagged_lemma']
                tag_cols = [tt, tl]
                ...
                dataframe['tagged_token'] = tt
                dataframe['tagged_lemma'] = tl
